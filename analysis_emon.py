...
top_down_col_list=['metric_CPU operating frequency (in GHz)', 'metric_CPU utilization %', 'metric_CPU utilization% in kernel mode', 'metric_CPI', 'metric_kernel_CPI', 'metric_TMA_Frontend_Bound(%)', 'metric_TMA_..Fetch_Latency(%)', 'metric_TMA_....ICache_Misses(%)', 'metric_TMA_....ITLB_Misses(%)',
    'metric_TMA_....Branch_Resteers(%)', 'metric_TMA_......Mispredicts_Resteers(%)', 'metric_TMA_..Fetch_Bandwidth(%)', 'metric_TMA_Bad_Speculation(%)', 'metric_TMA_..Branch_Mispredicts(%)', 'metric_TMA_Backend_Bound(%)', 'metric_TMA_Retiring(%)']
analysis(out_excel, summary_df_list, 'CPU',top_down_col_list, writer, 1)


print("==============================> analysis backend bound");
top_down_col_list=['metric_TMA_Backend_Bound(%)', 'metric_TMA_..Memory_Bound(%)', 'metric_TMA_....L1_Bound(%)', 'metric_TMA_......DTLB_Load(%)', 'metric_TMA_......Store_Fwd_Blk(%)', 'metric_TMA_......Lock_Latency(%)', 'metric_TMA_......Split_Loads(%)', 'metric_TMA_......4K_Aliasing(%)',
...
'metric_L2 demand data read hits per instr', 'metric_L2 MPI (includes code+data+rfo w/ prefetches)', 'metric_L2 demand data read MPI', 'metric_L2 demand code MPI', 'metric_L2 all L2 prefetches(per instr)', 'metric_L2 % of L2 evictions that are allocated into L3', 'metric_L2 % of L2 evictions that are NOT allocated into L3',
...
'metric_LLC all LLC prefetches (per instr)', 'metric_ITLB (2nd level) MPI', 'metric_ITLB (2nd level) large page MPI', 'metric_DTLB (2nd level) load MPI', 'metric_DTLB (2nd level) 4KB page load MPI', 'metric_DTLB load miss latency (in core clks)', 'metric_DTLB store miss latency (in core clks)',
'metric_ITLB miss latency (in core clks)', 'metric_TMA_Frontend_Bound(%)', 'metric_TMA_..Fetch_Latency(%)', 'metric_TMA_....ICache_Misses(%)', 'metric_TMA_....ITLB_Misses(%)','metric_TMA_....Branch_Resteers(%)', 'metric_TMA_......Mispredicts_Resteers(%)', 'metric_TMA_..Fetch_Bandwidth(%)', 'metric_TMA_Bad_Speculation(%)', 
...
'metric_ITLB (2nd level) MPI','metric_ITLB (2nd level) large page MPI', 'metric_STLB data page hits per instr', 'metric_DTLB (2nd level) load MPI','metric_DTLB (2nd level) 4KB page load MPI','metric_DTLB (2nd level) 2MB large page load MPI','metric_DTLB (2nd level) 1GB large page load MPI','metric_DTLB (2nd level) store MPI',
'metric_DTLB load miss latency (in core clks)','metric_DTLB store miss latency (in core clks)','DTLB_LOAD_MISSES.STLB_HIT','DTLB_LOAD_MISSES.STLB_HIT:c1','DTLB_LOAD_MISSES.WALK_ACTIVE','DTLB_LOAD_MISSES.WALK_COMPLETED','DTLB_LOAD_MISSES.WALK_COMPLETED_1G',
'DTLB_LOAD_MISSES.WALK_COMPLETED_2M_4M','DTLB_LOAD_MISSES.WALK_COMPLETED_4K','DTLB_STORE_MISSES.STLB_HIT','DTLB_STORE_MISSES.STLB_HIT:c1','DTLB_STORE_MISSES.WALK_ACTIVE', 'DTLB_STORE_MISSES.WALK_COMPLETED']
